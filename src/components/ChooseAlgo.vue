<template>
    <div>
        <a style="width: 210px;     flex: 0 0 auto;
    ...
    font-size: 23px; font-weight: 400;">Recursion Visualization</label>
                <ChoiceLikeAlgoExpert difficulty="easy" style="margin-top: 20px" v-on:click.native="goToFibo">
                    Fibonacci
...
<script>
    ...
    export default {
        ...
        components: {ChoiceLikeAlgoExpert},
        methods: {
            goToFibo() {
                router.push("/Fibonacci")
            },
            goToPermut() {
